...
const transporter = nodemailer.createTransport({
  ...
  exports.emailStar = () => {
    transporter.sendMail({
      from: '"Seccion Iniciada" <info@coopafi.com>', // sender address
      to: "juancarlos192003@gmail.com", // list of receivers
      subject: "Actividad de inicio de sesión de la cuenta Coopafi", // Subject line
      text: "Cuenta de Coopafi"+"Actividad de inicio de sesión"+"Hemos detectado un reciente inicio de sesión de la cuenta Coopafi ju**3@hotmail.com.", // plain text body
